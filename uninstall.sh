...
echo "  • Any PROJECT_INDEX.dsl files in your projects"
...
echo ""
echo "   Remove PROJECT_INDEX.dsl files from your projects:"
echo "   • Find them with: find ~ -name 'PROJECT_INDEX.dsl' -type f 2>/dev/null"
echo ""
